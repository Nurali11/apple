...
class Watch_Window(QWidget):
    def __init__(self, obj):
        self.obj = obj
        super().__init__()
        self.setWindowTitle("watch Models")
        ...
        watch_models = [
            ("watch1.png", "Apple Watch Series-9", "$550"),
            ("watch2.png", "Apple Watch Ultra-2", "$990"),
            ("watch3.png", "Apple Watch SE", "$299"),
            ("watch4.png", "Apple Watch Nike", "$750")
        ]

        for i, (image_path, model_name, price) in enumerate(watch_models):
            frame = Watch_Frame(image_path, model_name, price)
